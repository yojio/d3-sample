...
define(
    ...
    function() {
      ...
      // Chart
      this.ChartCreator = function() {

        this.pieChart = function(option) {
          //return new PieChart(option).init();
        };

        this.lineChart = function(option) {
          //return new LineChart(option).init();
        };

        this.holizontalBarChart = function(option) {
          //return new HolizontalBarChart(option).init();
        };

        this.varticalBarChart = function(option) {
