...
//                }
        ...
        _createAxisY: {
            value: function _createAxisY(svg, opt, top, left, height, width) {
                ...
                var temp2 = svg.append("g")
                .attr("class", "axis heatmap3")
                .style("font-size", "15px")
                .attr("transform", "translate(" + left + "," + top + ")")
                .call(d3.svg.axis()
                    .scale(yScale) // スケールを適用する
                ...
                temp2.selectAll("path")
                .style("fill", "none")
                .style("stroke", "none");

                temp2.selectAll(".tick line")
                .style("stroke", "black")
                .style("opacity", "0.2");
